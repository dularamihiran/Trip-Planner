// Seed script to populate DynamoDB Places table with Sri Lankan attractions
...
async function seedPlaces() {
  console.log('🌱 Starting to seed Places table...\n');
  ...
  try {
    ...
    if (existingData.Items && existingData.Items.length > 0) {
      console.log(`⚠️  Found ${existingData.Items.length} existing places in the table.`);
      console.log('❓ Do you want to proceed? This will add new places (duplicates may occur).\n');
    }
